...
| ESA news | Linking safe | Commercial republication not automatic | ESA and item attribution | None | Metadata/minimal excerpt only until approved | No full-text redistribution by default | Do not mirror media | No training without permission | **Red-Amber** |
