...
export function mapBreakingCategory(item:{category:string}):import("./breaking-contract").BreakingCategory;
export function timelinePriority(item:import("../timeline/timeline-contract").TimelineItem,category:import("./breaking-contract").BreakingCategory):BreakingPriority;
